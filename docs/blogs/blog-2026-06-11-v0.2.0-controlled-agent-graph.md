...
![AI Mind v0.2.0 Tasklist Agent 执行过程](../../assets/screenshots/version-images/v0.2.0/agent-main.gif)
...
![AI Mind v0.2.0 Tasklist Agent 输入交互](../../assets/screenshots/version-images/v0.2.0/p1.png)

它的输出不是直接写文件，而是通过 `AgentTextArtifactPanel`（产物展示面板）展示一份可复制的 tasklist Markdown。

![AI Mind v0.2.0 Tasklist Agent 输出交互](../../assets/screenshots/version-images/v0.2.0/p2.png)
