...
import { AgentTracePanel } from '@/components/chat/message-list/parts/tasklist-agent/agent-trace-panel'
import type { AgentGraphPart, ResourcePart, ToolPart } from '@/lib/ai/types/message'
...
function createGraphAgentStepPart(overrides?: Partial<AgentGraphPart>): AgentGraphPart {
    return {
