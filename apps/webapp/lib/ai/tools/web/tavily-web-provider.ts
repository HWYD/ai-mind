...
export { WebProviderError } from '@/lib/ai/tools/web/web-provider'
...
function invalidResponseError(): WebProviderError {
    return new WebProviderError('WEB_INVALID_RESPONSE', '网页服务返回了无效响应。', { provider: 'tavily', retryable: false })
}
