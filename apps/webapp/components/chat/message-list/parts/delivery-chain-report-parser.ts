...
const DELIVERY_CHAIN_SECTION_IDS: Record<string, string> = {
    ...
    交付结论: 'delivery-status',
    前提假设: 'assumptions',
    失败摘要: 'failure-summary',
    已保留的评审证据: 'review-evidence',
    当前产物版本: 'artifact-versions',
    实现方案: 'implementation-plan',
    评审覆盖: 'review-coverage',
    待处理事项: 'action-items',
    评审观察: 'review-observations',
    修订结果: 'revision-outcome',
    原问题处理结果: 'finding-resolution',
    复审遗留问题: 'residual-findings',
    提示: 'warnings',
    下一步: 'next-steps',
    默认假设: 'assumptions',
    非目标: 'non-goals',
